document.addEventListener("DOMContentLoaded", () => {
  ...
  function showQuestion() {
    ...
    const progressIndex = (quiz.currentQuestionIndex / questions.length) * 100;
    progressBar.style.width = `${progressIndex}%`; // This value is hardcoded as a placeholder
    ...
    for (let choice in question.choices) {
      ...
      choiceRadio.id = `choice${choice}`;
      choiceRadio.value = question.choices[choice];
      const choiceLabel = document.createElement("label");
      choiceLabel.htmlFor = `choice${choice}`;
      choiceLabel.innerText = question.choices[choice];
